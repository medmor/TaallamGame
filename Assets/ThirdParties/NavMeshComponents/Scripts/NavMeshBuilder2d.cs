...
namespace NavMeshPlus.Extensions
{
    ...
    class NavMeshBuilder2d
    {
        ...
        { 
            // 'usedByComposite' is deprecated. If a CompositeCollider2D is present on the object,
            // prefer using it (it represents the combined shape). Otherwise use the collider directly.
